...
#
# --------------------------------------------------------
# training executable for SAB3R
# --------------------------------------------------------
from mast3r.model import AsymmetricMASt3R
from mast3r.losses import ConfMatchingLoss, MatchingLoss, APLoss, Regr3D, InfoNCE, Regr3D_ScaleShiftInv, ConfFeatLoss, FeatRegr3D_ScaleShiftInv
from mast3r.datasets import ARKitScenes, BlendedMVS, Co3d, MegaDepth, ScanNetpp, StaticThings3D, Waymo, WildRGBD, Habitat512
...
dust3r.training.ConfFeatLoss = ConfFeatLoss
dust3r.training.FeatRegr3D_ScaleShiftInv = FeatRegr3D_ScaleShiftInv
...
dust3r.datasets.Habitat512 = Habitat512

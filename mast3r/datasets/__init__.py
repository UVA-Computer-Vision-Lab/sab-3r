...
from dust3r.datasets.habitat import Habitat as DUSt3R_Habitat # noqa
...
class Habitat512(DUSt3R_Habitat, MASt3RBaseStereoViewDataset):
    def __init__(self, size, *args, ROOT, **kwargs):
        super().__init__(size=size, *args, ROOT=ROOT, **kwargs)
        self.is_metric_scale = True
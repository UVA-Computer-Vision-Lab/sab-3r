...
class Co3d(BaseStereoViewDataset):
    ...
    def _get_views(self, idx, resolution, rng):
        ...
        while len(imgs_idxs) > 0:  # some images (few) have zero depth
            ...
            rgb_image_orig = imread_cv2(impath)
            ...
            rgb_image, depthmap, intrinsics, rgb_image_crop = self._crop_resize_if_necessary(
                rgb_image_orig, depthmap, intrinsics, resolution, rng=rng, info=impath)
            ...
            image_tensor = transform(rgb_image) # 3, input size[1], input size[0]
            ...
            views.append(dict(
                img=rgb_image,
                img_orig=np.array(rgb_image_crop),
                depthmap=depthmap,

...
def save_model(args, epoch, model_without_ddp, optimizer, fname=None, best_so_far=None):
...
def adjust_learning_rate(optimizer, epoch, args):
    ...
    if epoch < args.training.warmup_epochs:
        lr = args.training.lr * epoch / args.training.warmup_epochs 
    else:
        lr = args.training.min_lr + (args.training.lr - args.training.min_lr) * 0.5 * \
            (1. + math.cos(math.pi * (epoch - args.training.warmup_epochs) / (args.training.epochs - args.training.warmup_epochs)))
